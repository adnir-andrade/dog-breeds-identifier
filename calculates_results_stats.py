...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic["n_dogs_img"] = sum(1 for value in results_dic.values()
                                          if value[3] == 1)
    results_stats_dic["n_notdogs_img"] = sum(1
                                             for value in results_dic.values()
                                             if value[3] == 0)
    results_stats_dic["n_match"] = sum(1 for value in results_dic.values()
                                       if value[2] == 1)
    ...
    results_stats_dic["pct_match"] = calculate_percentage(
        results_stats_dic["n_match"], results_stats_dic["n_images"])

    results_stats_dic["pct_correct_dogs"] = calculate_percentage(
        results_stats_dic["n_correct_dogs"], results_stats_dic["n_dogs_img"])

    results_stats_dic["pct_correct_breed"] = calculate_percentage(
        results_stats_dic["n_correct_breed"], results_stats_dic["n_dogs_img"])

    results_stats_dic["pct_correct_notdogs"] = calculate_percentage(
...
def calculate_percentage(divisor, dividend):
    if dividend != 0:
